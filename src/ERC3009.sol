...
/**
 * @title ERC3009
 * @notice Abstract implementation of EIP-3009 for gas-abstracted transfers
 * @dev Inherits IERC20 but doesn't implement it - subclasses must implement IERC20 functions
 */
abstract contract ERC3009 is IERC20, IERC3009 {
    ...
    function _transferWithAuthorization(
        ...
        // Use IERC20 transferFrom to transfer from the authorizer
        require(IERC20(address(this)).transferFrom(from, to, value), "ERC3009: transfer failed");
    }
